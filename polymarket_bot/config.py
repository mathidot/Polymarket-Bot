...
PRICE_FRESHNESS_SECONDS = float(os.getenv("PRICE_FRESHNESS_SECONDS", "3.0"))
...
PROB_ENTRY_THRESHOLD = float(os.getenv("PROB_ENTRY_THRESHOLD", "0.80"))
PROB_STOP_THRESHOLD = float(os.getenv("PROB_STOP_THRESHOLD", "0.60"))
