...
# Settlement sweep configuration
SETTLEMENT_SWEEP_ENABLE = os.getenv("SETTLEMENT_SWEEP_ENABLE", "true").lower() == "true"
SETTLED_PRICE_LOW = float(os.getenv("SETTLED_PRICE_LOW", "0.001"))
SETTLED_PRICE_HIGH = float(os.getenv("SETTLED_PRICE_HIGH", "0.999"))
SETTLEMENT_SWEEP_INTERVAL_SEC = float(os.getenv("SETTLEMENT_SWEEP_INTERVAL_SEC", "5"))
